...
var GulpTaskManager = (function (_TaskManager) {
    ...
    function GulpTaskManager(taskRunner, argv, env, config) {
        _classCallCheck(this, GulpTaskManager);

        _get(Object.getPrototypeOf(GulpTaskManager.prototype), 'constructor', this).call(this, taskRunner, argv, env, config);
    }
